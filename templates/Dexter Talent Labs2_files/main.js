var dtl = {
    ...
    initInstagram : function() {
        $('.insta').simpleInstagramFancybox({
            ...
            userID : '', // This is a setting that you have to use if your using "user" mode. Default is "For stunning photography – Kevin Burg".
    ...
    initFancybox : function() {
        $('.trigger-fancybox').fancybox({
            ...
            beforeShow: function() {
                var closeButton = $('<button class="dtl-close dtl-fancy"><i class="entyp-cancel-1"></i></button>');
                var fullscreenButton = $('<button class="dtl-fullscreen dtl-fancy"><i class="entyp-resize-full-1"></i></button>');
    ...
    addMobileButton : function() {
        ...
        if(el.find('>ul').length) {
            el.append(button);
            button.click(dtl.mobileDropdown);
        }
    },
